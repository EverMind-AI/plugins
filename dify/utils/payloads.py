...
def project_id(credentials: dict[str, Any]) -> str:
    value = credentials.get("project_id") or "default"
    return _path_safe_id(value, "project_id")
...
def build_search_payload(
    *,
    ...
    return {
        ...
        # Keyword recall is available in EverOS's LLM-only basic tier.
        "method": "keyword",
        "top_k": top_k(limit),
